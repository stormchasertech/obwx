        ...
        super(OBWX_Installer, self).__init__(
            ...
            files=[('bin/user', ['bin/user/obwx.py']),
                ('skins/obwx',
                    ...
                    'skins/obwx/obwx.json.tmpl',
                    'skins/obwx/obwx.js.tmpl',
                    'skins/obwx/skin.conf',
                    ]
                ),
                ('skins/obwx/include-html',
                    [
                    'skins/obwx/include-html/foot.html.tmpl',
                    'skins/obwx/include-html/head.html.tmpl',
                    'skins/obwx/include-html/r1c1-logo.html.tmpl',
                    'skins/obwx/include-html/r1c2-alerts.html.tmpl',
                    'skins/obwx/include-html/r1c3-datetime.html.tmpl',
                    'skins/obwx/include-html/r2c1-current.html.tmpl',
                    'skins/obwx/include-html/r2c2-wind.html.tmpl',
                    'skins/obwx/include-html/r2c3-rain.html.tmpl',
                    'skins/obwx/include-html/r3c1-extras.html.tmpl',
                    'skins/obwx/include-html/r3c2-metar.html.tmpl',
                    'skins/obwx/include-html/r3c3-sunmoon.html.tmpl',
                    'skins/obwx/include-html/r4-forecast.html.tmpl',
                    ]
                ),
                ('skins/obwx/include-json',
                    [
                    'skins/obwx/include-json/almanac.json.inc',
                    'skins/obwx/include-json/current.json.inc',
                    'skins/obwx/include-json/station.json.inc',
                    'skins/obwx/include-json/today.json.inc',
                    ]
                ),
                ('skins/obwx/icons',
                    [
